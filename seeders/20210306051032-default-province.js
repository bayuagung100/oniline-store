  ...
  up: async (queryInterface, Sequelize) => {
    ...
    */
    await queryInterface.bulkInsert('Province', [
      ...
      {
        provinceId: '21', provinceName: 'Nanggroe Aceh Darussalam (NAD)',
      },
      {
        provinceId: '22', provinceName: 'Nusa Tenggara Barat (NTB)',
      },
      {
        provinceId: '23', provinceName: 'Nusa Tenggara Timur (NTT)',
      },
      {
